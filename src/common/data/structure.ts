...
<ul>
  ...
  <li>建议携带牛奶解毒</li>
    ...
    },
    {
        name: '要塞',
        category: '地下结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/a/ae/StrongholdPortalRoom.png/revision/latest/scale-to-width-down/1000',
...
<ul>
  ...
  <li>箱子中有各种有用的战利品</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/7/78/EndPortalRoom.png/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/4/4a/End_Portal_Spawner.png/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/a/ae/Large_Stronghold_Library.png/revision/latest'
        ]
    },
    {
        name: '古迹废墟',
        category: '地下结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/6/67/Trail_Ruins.png/revision/latest/scale-to-width-down/1000',
...
<ul>
  ...
  <li>陶瓦图案具有考古价值</li>
    ...
    // 地上结构
    {
        name: '沙漠神殿',
        category: '地上结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/e/ed/Desert_Pyramid.png/revision/latest/scale-to-width-down/1000',
...
<ul>
  ...
  <li>触发TNT会炸毁所有战利品</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/2/2e/Desert_Temple_Interior.png/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/d/dc/The_four_chests_with_the_TNT_trap.png/revision/latest/scale-to-width-down/1000'
        ]
    },
    {
        name: '雪屋',
        category: '地上结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/e/e0/Igloo_top.png/revision/latest',
...
<ul>
  ...
  <li>这些物品可用于治愈僵尸村民</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/7/71/Igloo_bottom.png/revision/latest/scale-to-width-down/1000'
        ]
    },
    {
        name: '丛林神庙',
        category: '地上结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/b/ba/Jungle_Pyramid.png/revision/latest',
...
<ul>
  ...
  <li>谜题房间箱子：金锭、钻石、马铠、附魔书等</li>
    ...
    },
    {
        name: '掠夺者前哨站',
        category: '地上结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/8/8c/Pillager_outpost_watchtower.png/revision/latest/scale-to-width-down/250',
...
<ul>
  ...
  <li>建议充分准备后再前往</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/8/87/Pillager_outpost_in_taiga.png/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/e/e4/Desertoutpost.png/revision/latest/scale-to-width-down/1000'
        ]
    },
    {
        name: '沼泽小屋',
        category: '地上结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/1/15/Swamp_Hut.png/revision/latest',
...
<ul>
  ...
  <li>黑猫可以驯服为宠物</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/7/78/Swamp_Hut_inside.png/revision/latest/scale-to-width-down/1000'
        ]
    },
    {
        name: '村庄',
        category: '地上结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/0/01/Plains_Small_House_3.png/revision/latest',
...
<ul>
  ...
  <li>可能受到袭击事件威胁</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/1/1b/NewPlainsVillage.png/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/1/1d/Taiga_Village_1_14_1.png/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/0/0a/Snowy_Village.png/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/6/6a/Abandoned_Village.png/revision/latest/scale-to-width-down/1000',
        ]
    },
    {
        name: '林地府邸',
        category: '地上结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/5/5d/Woodland_Mansion.png/revision/latest/scale-to-width-down/1000',
...
<ul>
  ...
  <li>唱片和独特物品</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/a/a8/Woodland_Mansion_Ingame.png/revision/latest'
        ]
    },
    // 水下结构
    {
        name: '海底神殿',
        category: '水下结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/2/2c/Ocean_monument.png/revision/latest',
...
<ul>
  ...
  <li>鱼（守卫者掉落）</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/e/e9/Sponge_and_treasure.png/revision/latest'
        ]
    },
    {
        name: '海底废墟',
        category: '水下结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/b/bb/Ruin_Big_Brick_1.png/revision/latest/scale-to-width-down/220',
...
<ul>
  ...
  <li>考古发现：陶片、锻造模板</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/2/28/Ruin_Big_Brick_2.png/revision/latest/scale-to-width-down/220',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/2/21/Ruin_Big_Warm_4.png/revision/latest/scale-to-width-down/220'
        ]
    },
    {
        name: '沉船',
        category: '水下结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/c/cc/Shipwreck_Oak_%28With_Mast%29.png/revision/latest/scale-to-width-down/208',
...
<ul>
  ...
  <li>宝藏箱：铁锭、金锭、绿宝石、钻石等</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/2/2c/Rightsideup_full.png/revision/latest/scale-to-width-down/208',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/6/6e/Rightsideup_fronthalf.png/revision/latest/scale-to-width-down/208',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/3/3f/Rightsideup_backhalf_degraded.png/revision/latest/scale-to-width-down/208',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/b/b1/Sideways_full.png/revision/latest/scale-to-width-down/208',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/1/1b/Upsidedown_full_degraded.png/revision/latest/scale-to-width-down/208'
        ]
    },
    // 下界
    {
        name: '堡垒遗迹',
        category: '下界结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/2/26/Bastion_Remnant_2.png/revision/latest/scale-to-width-down/1000',
...
<ul>
  ...
  <li>钻石装备</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/e/e5/NetherRuinsBridge.png/revision/latest'
        ]
    },
    {
        name: '下界要塞',
        category: '下界结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/3/39/Blaze_Fortress.png/revision/latest',
...
<ul>
  ...
  <li>战利品箱子</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/f/fe/New_Nether_2_bright.jpg/revision/latest/scale-to-width-down/1000',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/a/a6/Nether_Fortress_Large_Stairs_Room.png/revision/latest'
        ]
    },
    {
        name: '下界化石',
        category: '下界结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/d/df/Nether_fossil_1.png/revision/latest/scale-to-width-down/150',
...
<ul>
  ...
  <li>指示灵魂沙峡谷区域</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/8/8d/Nether_fossil_6.png/revision/latest/scale-to-width-down/150',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/d/d7/Nether_fossil_14.png/revision/latest/scale-to-width-down/150'
        ]
    },
    // 末地
    {
        name: '末地城',
        category: '末地结构',
        image: 'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/d/d8/EndCityEntrance.png/revision/latest/scale-to-width-down/1000',
...
<ul>
  ...
  <li>战利品：附魔钻石装备、附魔书、金苹果、潜影壳等</li>
        ...
        images: [
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/3/32/End_Ship.png/revision/latest',
            'https://static.wikia.nocookie.net/minecraft_zh_gamepedia/images/e/ec/EndCityBanners.png/revision/latest'
        ]
    }
]
